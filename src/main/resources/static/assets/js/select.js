...
!function ($) {
  ...
  Multiselect.prototype = {
    ...
    defaults: {
      ...
      buttonText: function (options, select) {
        ...
        } else
        {
          ...
          if (options.length > 1) {
            return options.length - 1 + ' ' + this.nSelectedText + ' <b class="caret"></b>';
          } else
          {
            var selected = '';
            ...
            return selected.substr(0, selected.length - 2) + ' <b class="fa fa-calendar"></b>';
          }
        }
      },
                ...
                $.each($('li', this.$ul), $.proxy(function (index, element) {
                  ...
                  if (value != this.options.selectAllValue) {
                    ...
                    if (value && text && value != this.options.selectAllValue) {
                      ...
                      if (filterCandidate.indexOf(this.query) > -1) {
                        showElement = true;
                      }
    ...
    select: function (selectValues) {
      ...
      for (var i = 0; i < selectValues.length; i++) {if (window.CP.shouldStopExecution(0)) break;
    ...
    deselect: function (deselectValues) {
      ...
      for (var i = 0; i < deselectValues.length; i++) {if (window.CP.shouldStopExecution(1)) break;
